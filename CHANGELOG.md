...
- Chart: Update CAPI to v1.13.6-gs-bf722b65f.

## [8.0.0] - 2026-09-08

### Changed

- Chart: Update CAPI to v1.13.5-gs-5331bfa07.
...
- Chart: Update CAPI to v1.12.8-gs-6158079b4.
...
- Chart: Update CAPI to v1.11.4-gs-f57c6822a. ([#317](https://github.com/giantswarm/cluster-api-app/pull/317))
...
- Chart: Rework network policies. ([#309](https://github.com/giantswarm/cluster-api-app/pull/309))
...
- Chart: Upgrade CAPI to v1.7.9. ([#236](https://github.com/giantswarm/cluster-api-app/pull/236))
...
[Unreleased]: https://github.com/giantswarm/cluster-api-app/compare/v8.0.0...HEAD
...
[6.0.1]: https://github.com/giantswarm/cluster-api-app/compare/v6.0.0...v6.0.1
...
[3.1.2]: https://github.com/giantswarm/cluster-api-app/compare/v3.1.1...v3.1.2
